...
const translations = {
  id: {
    ...
    // Portal
    "portal.login.title": "Masuk Klien",
    "portal.login.email": "Email",
    "portal.login.password": "Kata sandi",
    "portal.login.submit": "Masuk",
    "portal.login.error": "Email atau kata sandi salah",
    "portal.login.register": "Belum punya akun? Daftar",
    "portal.register.title": "Daftar Klien",
    "portal.register.name": "Nama",
    "portal.register.email": "Email",
    "portal.register.password": "Kata sandi",
    "portal.register.confirm": "Konfirmasi kata sandi",
    "portal.register.company": "Perusahaan",
    "portal.register.phone": "No. HP / WhatsApp",
    "portal.register.note": "Catatan / kebutuhan",
    "portal.register.submit": "Daftar",
    "portal.register.haveAccount": "Sudah punya akun? Masuk",
    "portal.register.success": "Pendaftaran terkirim. Menunggu persetujuan admin.",
    "portal.register.errorValidation": "Periksa kembali isian Anda (kata sandi minimal 8 karakter & harus cocok).",
    "portal.register.errorExists": "Email ini sudah terdaftar atau sedang diproses.",
    "portal.logout": "Keluar",
    "portal.projects.title": "Project Anda",
    "portal.projects.empty": "Belum ada project.",
    "portal.stage": "Tahap",
    "portal.progress": "Progres",
    "portal.viewLive": "Lihat Live",
    "portal.section.prd": "Ringkasan Project",
    "portal.section.updates": "Update",
    "portal.section.tasks": "Task",
    "portal.section.deliverables": "Deliverable",
    "portal.tasksDone": "selesai",
    "portal.approve": "Setujui",
    "portal.requestRevision": "Minta revisi",
    "portal.revisionNote": "Apa yang perlu diubah?",
  ...
  en: {
    ...
    // Portal
    "portal.login.title": "Client Login",
    "portal.login.email": "Email",
    "portal.login.password": "Password",
    "portal.login.submit": "Sign in",
    "portal.login.error": "Invalid email or password",
    "portal.login.register": "No account? Register",
    "portal.register.title": "Client Registration",
    "portal.register.name": "Name",
    "portal.register.email": "Email",
    "portal.register.password": "Password",
    "portal.register.confirm": "Confirm password",
    "portal.register.company": "Company",
    "portal.register.phone": "Phone / WhatsApp",
    "portal.register.note": "Notes / needs",
    "portal.register.submit": "Register",
    "portal.register.haveAccount": "Already have an account? Log in",
    "portal.register.success": "Registration submitted. Awaiting admin approval.",
    "portal.register.errorValidation": "Please check your input (password min 8 chars and must match).",
    "portal.register.errorExists": "This email is already registered or is being processed.",
    "portal.logout": "Log out",
    "portal.projects.title": "Your Projects",
    "portal.projects.empty": "No projects yet.",
    "portal.stage": "Stage",
    "portal.progress": "Progress",
    "portal.viewLive": "View Live",
    "portal.section.prd": "Project Brief",
    "portal.section.updates": "Updates",
    "portal.section.tasks": "Tasks",
    "portal.section.deliverables": "Deliverables",
    "portal.tasksDone": "done",
    "portal.approve": "Approve",
    "portal.requestRevision": "Request revision",
    "portal.revisionNote": "What needs to change?",
