...
```bash
git remote add encore encore://vorca-studio-website-mhd2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/vorca-studio-website-mhd2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/vorca-studio-website-mhd2/settings/integrations/github)
