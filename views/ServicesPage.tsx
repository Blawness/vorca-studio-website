    ...
    <div className="pt-16 bg-[#050b16] min-h-screen">
      ...
      <section className="py-20 bg-[#050b16] relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -right-24 -top-24 h-72 w-72 bg-blue-600/10 blur-3xl rounded-full" />
          <div className="absolute -left-20 bottom-0 h-64 w-64 bg-blue-500/8 blur-3xl rounded-full" />
        </div>

        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-xs uppercase tracking-[0.2em] text-blue-400 font-semibold mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {coreServices.map((service, index) => (
              <motion.div
                ...
                className="group"
              >
                <Card className="h-full bg-white/[0.02] border border-white/[0.06] hover:border-blue-500/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-600/20">
                  <CardHeader>
                    <div className="w-12 h-12 bg-blue-600/15 border border-blue-500/10 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-600/25 transition-colors">
      ...
      <section className="py-24 bg-[#050b16] relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-blue-600/6 rounded-full blur-3xl"></div>
          <div className="absolute top-1/3 right-0 w-80 h-80 bg-blue-500/5 blur-3xl rounded-full"></div>
        </div>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
                size="lg"
                className="h-auto rounded-2xl px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white font-semibold shadow-lg shadow-blue-600/20 transition-all duration-300 border-0"
              >
